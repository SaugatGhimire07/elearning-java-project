<%@ page contentType="text/html;charset=UTF-8" language="java" import="java.util.List, net.elearning.model.Course" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container mt-5">
	    ...
	    <a href="course?action=create" class="btn btn-primary mb-3">Create New Course</a>
	    ...
	    <table class="table table-bordered">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td>
	                	<a href="<%= request.getContextPath() %>/lesson?courseId=<%= course.getCourseId() %>" class="btn btn-info btn-sm">Add Lesson</a>
